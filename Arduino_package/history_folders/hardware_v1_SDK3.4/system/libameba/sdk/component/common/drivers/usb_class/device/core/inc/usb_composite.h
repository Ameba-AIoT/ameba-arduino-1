...
#define	MAX_CONFIG_INTERFACES		2	/* arbitrary; max 255 */
// predefine structure
...
extern int register_class_vendor_control_request_cb(struct usb_composite_dev *cdev, user_control_callback cb);
