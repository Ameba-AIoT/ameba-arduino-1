...
#define TX_VIQ_DESC_NUM         32
#define TX_VOQ_DESC_NUM         32
#define TX_BKQ_DESC_NUM         32
...
void C2HPacketHandler_8195A(PADAPTER padapter, u8 *pbuffer, u16 length);
#endif
...
void CCX_FwC2HTxRpt_8195A(PADAPTER padapter, u8 *pdata, u8 len);
s32 c2h_id_filter_ccx_8195A(u8 *buf);
s32 c2h_handler_8195A(PADAPTER padapter, u8 *pC2hEvent);
