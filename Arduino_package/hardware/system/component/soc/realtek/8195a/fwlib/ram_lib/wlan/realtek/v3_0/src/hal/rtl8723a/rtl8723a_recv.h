...
void rtl8723as_recv(_adapter * padapter, struct recv_buf *precvbuf);
#endif
s32 rtl8723as_init_recv_priv(_adapter * padapter);
void rtl8723as_free_recv_priv(_adapter * padapter);
#endif
