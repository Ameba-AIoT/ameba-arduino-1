...
/*--------------------------Define flash Parameters-------------------------*/
	...
	#define IS_FLASH_CAL_VALID(a)	((a > 0x1F && a < 0xD0) || (a > 0x10F && a < 0x120) || (a > 0x12F && a < 0x200)) ? 1 : 0
#endif
...
u16	efuse_GetMaxSize(_adapter * padapter);
...
void	ReadEFuseByte(_adapter * Adapter, u16 _offset, u8 *pbuf, BOOLEAN bPseudoTest) ;
...
u8	EFUSE_Read1Byte(_adapter * pAdapter, u16 Address);
...
u8 rtw_config_map_read(PADAPTER padapter, u16 addr, u16 cnts, u8 *data);
u8 rtw_config_map_write(PADAPTER padapter, u16 addr, u16 cnts, u8 *data);
