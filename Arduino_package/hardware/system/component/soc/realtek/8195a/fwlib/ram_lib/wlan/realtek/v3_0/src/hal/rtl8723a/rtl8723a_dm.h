...
void rtl8723a_init_dm_priv(_adapter * padapter);
void rtl8723a_deinit_dm_priv(_adapter * padapter);
	
void rtl8723a_InitHalDm(_adapter * padapter);
void rtl8723a_HalDmWatchDog(_adapter * padapter);
