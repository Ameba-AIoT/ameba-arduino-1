...
typedef struct _ODM_Phy_Status_Info_
{
	...
	s1Byte		RxMIMOSignalQuality[MAX_PATH_NUM_8195A];	//per-path's EVM
	u1Byte		RxMIMOEVMdbm[MAX_PATH_NUM_8195A]; 		//per-path's EVM dbm

	u1Byte		RxMIMOSignalStrength[MAX_PATH_NUM_8195A];// in 0~100 index

	u2Byte		Cfo_short[MAX_PATH_NUM_8195A]; 			// per-path's Cfo_short
	u2Byte		Cfo_tail[MAX_PATH_NUM_8195A];			// per-path's Cfo_tail
#else
	u1Byte		SignalQuality;	 		// in 0-100 index. 
...
#define ODM_IC_11N_SERIES		(ODM_RTL8192S|ODM_RTL8192C|ODM_RTL8192D|ODM_RTL8723A|ODM_RTL8188E|ODM_RTL8192E|ODM_RTL8723B|ODM_RTL8195A)
...
extern  const u4Byte TxScalingTable_Jaguar[TXSCALE_TABLE_SIZE];
