...
#define SCAN_RECONN_TO		FIVE_SEC
#define JOIN_RECONN_TO		FIVE_SEC
#define DEAUTH_RECONN_TO	FIVE_SEC
#define DEASSOC_RECONN_TO	FIVE_SEC
#define LINK_RECONN_TO		FIVE_SEC
#define PSK_RECONN_TO		FIVE_SEC
#endif
...
struct mlme_ext_priv
{
	...
	u8 link_reconnect;
	u8 deauth_reconnect;
	u8 deassoc_reconnect;
	u8 saved_alg;
	u8 saved_essid[32];
	u8 saved_key[32];
	u16 saved_key_len;
	u8 saved_key_idx;
	u8 saved_wpa_passphrase[64];
	u8 auto_reconnect;
#endif
	u8 partial_scan;
#ifdef CONFIG_CUSTOM_IE
