...
_LONG_CALL_
static size_t
__rtl_critical_factorization_v1_00 (const unsigned char *needle, size_t needle_len,
			size_t *period)
{
...
_LONG_CALL_
static RETURN_TYPE
__rtl_two_way_short_needle_v1_00 (const unsigned char *haystack, size_t haystack_len,
...
_LONG_CALL_
static RETURN_TYPE
__rtl_two_way_long_needle_v1_00 (const unsigned char *haystack, size_t haystack_len,
		     const unsigned char *needle, size_t needle_len)
{
  size_t i; /* Index into current byte of NEEDLE.  */
  size_t j; /* Index into current window of HAYSTACK.  */
