...
#define NUM_STA 8//(2 + AP_STA_NUM)	//2 + supported clients
#else
...
#define WLAN_MAX_PROTOCOL_OVERHEAD (WLAN_HDR_A4_QOS_LEN+WLAN_MAX_IV_LEN\
						+WLAN_SNAP_HEADER+WLAN_MAX_MIC_LEN+WLAN_MAX_ICV_LEN)	//=60
...
#define IEEE80211_BAR_CTRL_CBMTID_COMPRESSED_BA  0x0004
 ...
 #if defined(PLATFORM_LINUX) || defined(CONFIG_RTL8712FW) || defined(PLATFORM_FREEBSD) || defined(PLATFORM_ECOS) || defined(PLATFORM_FREERTOS)
