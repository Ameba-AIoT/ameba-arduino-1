...
#ifdef PLATFORM_ECOS
//TODO
#include "../src/hal/OUTSRC/odm_precomp.h"
#else
...
// rtl8723a_hal_init.c
s32 rtl8723a_FirmwareDownload(_adapter * padapter);
void rtl8723a_FirmwareSelfReset(_adapter * padapter);
void rtl8723a_InitializeFirmwareVars(_adapter * padapter);

void rtl8723a_InitAntenna_Selection(_adapter * padapter);
void rtl8723a_DeinitAntenna_Selection(_adapter * padapter);
void rtl8723a_CheckAntenna_Selection(_adapter * padapter);
void rtl8723a_init_default_value(_adapter * padapter);

s32 InitLLTTable(_adapter * padapter, u32 boundary);

s32 CardDisableHWSM(_adapter * padapter, u8 resetMCU);
s32 CardDisableWithoutHWSM(_adapter * padapter);

// EFuse
u8 GetEEPROMSize8723A(_adapter * padapter);
void Hal_InitPGData(_adapter * padapter, u8 *PROMContent);
void Hal_EfuseParseIDCode(_adapter * padapter, u8 *hwinfo);
void Hal_EfuseParseTxPowerInfo_8723A(_adapter * padapter, u8 *PROMContent, BOOLEAN AutoLoadFail);
void Hal_EfuseParseBTCoexistInfo_8723A(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseEEPROMVer(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void rtl8723a_EfuseParseChnlPlan(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseCustomerID(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseAntennaDiversity(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseRateIndicationOption(_adapter * padapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseXtal_8723A(_adapter * pAdapter, u8 *hwinfo, u8 AutoLoadFail);
void Hal_EfuseParseThermalMeter_8723A(_adapter * padapter, u8 *hwinfo, u8 AutoLoadFail);
...
void SetHwReg8723A(_adapter * padapter, u8 variable, u8 *val);
void GetHwReg8723A(_adapter * padapter, u8 variable, u8 *val);
#ifdef CONFIG_BT_COEXIST
void rtl8723a_SingleDualAntennaDetection(_adapter * padapter);
#endif

// register
void SetBcnCtrlReg(_adapter * padapter, u8 SetBits, u8 ClearBits);
void rtl8723a_InitBeaconParameters(_adapter * padapter);
void rtl8723a_InitBeaconMaxError(_adapter * padapter, u8 InfraMode);
