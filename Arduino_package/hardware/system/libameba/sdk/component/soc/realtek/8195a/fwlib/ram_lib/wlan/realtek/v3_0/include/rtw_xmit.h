...
/*--------------------------------------------------------------*/
#if defined(PLATFORM_OS_CE) || defined(PLATFORM_ECOS) || defined(PLATFORM_FREERTOS)
...
extern struct xmit_buf *_rtw_alloc_xmitbuf_ext(struct xmit_priv *pxmitpriv);
...
#define rtw_alloc_xmitbuf_ext(pxmitpriv, pxmitbuf) \
	(\
		pxmitbuf = _rtw_alloc_xmitbuf_ext(pxmitpriv),\
