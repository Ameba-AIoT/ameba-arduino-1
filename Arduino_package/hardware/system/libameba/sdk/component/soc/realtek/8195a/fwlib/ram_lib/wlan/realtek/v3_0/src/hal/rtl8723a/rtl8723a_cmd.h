...
void rtl8723a_set_FwPwrMode_cmd(_adapter * padapter, u8 Mode);
void rtl8723a_set_FwJoinBssReport_cmd(_adapter * padapter, u8 mstatus);
#ifdef CONFIG_BT_COEXIST
void rtl8723a_set_BTCoex_AP_mode_FwRsvdPkt_cmd(_adapter * padapter);
#endif
u8 rtl8192c_set_rssi_cmd(_adapter * padapter, u8 *param);
//u8 rtl8723a_set_rssi_cmd(_adapter * padapter, u8 *param);
u8 rtl8192c_set_raid_cmd(_adapter * padapter, u32 mask, u8 arg);
//u8 rtl8723a_set_raid_cmd(_adapter * padapter, u32 mask, u8 arg);
void rtl8192c_Add_RateATid(_adapter * padapter, u32 bitmap, u8 arg, u8 rssi_level);
//void rtl8723a_Add_RateATid(_adapter * padapter, u32 bitmap, u8 arg);
u8 rtl8192c_set_FwSelectSuspend_cmd(_adapter * padapter, u8 bfwpoll, u16 period);
//u8 rtl8723a_set_FwSelectSuspend_cmd(_adapter * padapter, u8 bfwpoll, u16 period);

#ifdef CONFIG_P2P
void rtl8192c_set_p2p_ps_offload_cmd(_adapter * padapter, u8 p2p_ps_state);
//void rtl8723a_set_p2p_ps_offload_cmd(_adapter * padapter, u8 p2p_ps_state);
#endif //CONFIG_P2P
