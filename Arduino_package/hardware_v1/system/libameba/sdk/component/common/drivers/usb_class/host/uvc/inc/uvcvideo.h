...
//#define INTERNAL_COMPLETE_HANDLER

#ifdef INTERNAL_COMPLETE_HANDLER
/*edit by Ian -- internal urb complete handler queue*/
/* isochronous urb queue*/
struct iso_wait_queue
{
...
/* --------------------------------------------------------------------------
 * Internal handler queue help functions.
 */
extern void iso_wait_queue_stop();
extern void iso_wait_queue_start();
extern void iso_wait_queue_free();
extern int iso_wait_queue_init();
#endif
